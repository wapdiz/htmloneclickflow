...
function get_stats_group_by_split(element){
    ...
    if(link.attr('loaded') == 1){
        ...
        $.ajax({
            url: '/statistic/get_stats_group_by_split',
            type: 'GET',
...
function get_stats_group_by_param(element){
    ...
    if($(element).attr('customWhereParams') == 1){
        ...
        $.ajax({
            url: '/statistic/get_stats_group_by_param_by_date_range',
            type: 'GET',
            ...
            beforeSend: function(){
                $('#stats_content_'+name_stats).html('<tr><td colspan="9" style="text-align:center;"><img src="/assets/images/load.gif"></td></tr>');
            },
            success: function(msg){
...
function get_stats_tab_content(element, name_stats){
    ...
    $.ajax({
        url: '/statistic/get_stats_tab_content',
        type: 'GET',
