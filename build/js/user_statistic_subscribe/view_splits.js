...
function get_stats_group_by_split(element){
    ...
    if(link.attr('loaded') == 1){
        ...
        $.ajax({
            url: '/statistic_subscribe/get_stats_group_by_split',
            type: 'GET',
...
function get_stats_group_by_param(element){
    ...
    if($(element).attr('customWhereParams') == 1){
        ...
        $.ajax({
            ...
            +'&Landings='+Landings,
            beforeSend: function(){
                $('#stats_content_'+name_stats).html('<tr><td colspan="15" style="text-align:center;"><img src="/assets/images/load.gif"></td></tr>');
            },
            success: function(msg){
