        ...
        <div class="col-md-12">
            <div class="tabs">
                <ul class="nav nav-tabs">
                    ...
                    <li>
                        <a href="#user" data-toggle="tab" name_stats_link="user" onClick="return get_stats_tab_content(this);">По пользователям</a>
                    </li>
                    <li>
                        <a href="#ip_diapason" data-toggle="tab" name_stats_link="ip_diapason" onClick="return get_stats_tab_content(this);">По диапазонам</a>
                    </li>
                    <li>
                        <a href="#subscribe" data-toggle="tab" name_stats_link="subscribe" onClick="return get_stats_tab_content(this);">По подпискам</a>
                    </li>
                    <li>
                        <a href="#buyout" data-toggle="tab" name_stats_link="buyout" onClick="return get_stats_tab_content(this);">По выкупам</a>
                    </li>
                ...
                <div class="tab-content">
                    ...
                    <div id="ip_diapason" class="tab-pane">                     
