            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group" id="form-editor-element2">
                        ...
                        <div class="col-md-9">
                            <textarea class="summernote"  id="hidden-text-input2" name="body" data-plugin-summernote data-plugin-options='{ "height": 180, "codemirror": { "theme": "ambiance" } }'>
                            </textarea>
                        </div>
                    </div>
                ...
                <footer class="panel-footer">
                    <button class="btn btn-primary">Добавить новость</button>
                </footer>
            </section>
        </form>
    </div>
