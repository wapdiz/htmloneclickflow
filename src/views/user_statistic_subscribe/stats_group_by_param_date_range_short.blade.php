        ...
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                @if($customWhereParams == 1)
                    ...
                    @if($full_stat == 1)
                        @include('user_statistic_subscribe/custom_where_params', ['name' => $name, 'customFilter' => $customFilter])
                    @else
                        @include('user_statistic_subscribe/custom_where_params_short', ['name' => $name, 'customFilter' => $customFilter])
                    @endif 
